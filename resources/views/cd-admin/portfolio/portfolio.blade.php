        ...
        <div class="col-xs-12">
           <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                 <a href="{{url('/portfolio-add')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Portfolio</button></a>
              </h3>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$pa->name}}</td>
                  <td height="75px">
                     <form action="{{url('/packagestatus/'.$pa->id)}}" method="POST">
                      {{csrf_field()}}
                    <div class="btn-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLongTitle"><strong>Portfolio Category :{{$t->name}}</strong></h3>
      ...
      <div class="modal-body">
        ...
        <p>  <img src="{{url('/imageupload/'.$t->image)}}" style="width: 500px;"></p>
...
<div class="modal modal-danger fade" id="modal-danger{{$t->id}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
               ...
               <a href="{{url('/deletepackage/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form role="form" action= "{{url('/packageupdate/'.$t->id)}}" enctype="multipart/form-data" method="post">
          {{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="price" id="price" value="{{$t->price}}"> 
            </div>
