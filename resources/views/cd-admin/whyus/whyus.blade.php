    ...
    <section class="content-header">
     ...
     Our Characters
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View Why us</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
           <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                 <a href="{{url('/whyus-add')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Why us?</button></a>
              </h3>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$pa->point}}</td>
                  <td height="75px">
                     <form action="{{url('/whyusstatus/'.$pa->id)}}" method="POST">
                      {{csrf_field()}}
                    <div class="btn-group">
...
<div class="modal modal-danger fade" id="modal-danger{{$t->id}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
               ...
               <a href="{{url('/deletewhyus/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form role="form" action= "{{url('/whyusupdate/'.$t->id)}}" enctype="multipart/form-data" method="post">
          {{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <label for="title" >Add Your service</label>
              <div class="text text-danger">{{$errors->first('point')}}</div>
              <input type="text" class="form-control" name="point" id="point" value="{{$t->point}}">
            </div>
