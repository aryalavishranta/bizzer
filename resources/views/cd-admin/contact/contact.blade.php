  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
         <a href="{{url('/replycontact/'.$er->id)}}"><button type="submit" class="btn btn-primary pull-left">Reply</button></a>
...
<div class="modal modal-danger fade" id="modal-danger{{$er['id']}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <a href="{{url('/deleteinbox/'.$er['id'])}}"> <button type="button" class="btn btn-outline">Yes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
